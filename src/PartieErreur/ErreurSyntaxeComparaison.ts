 ...
 */
export class ErreurSyntaxeComparaison extends ErreurConceptuelle {
	// ATTRIBUTS  -- Non --
	 ...
	 */
	static detecterAnomalie(StructureAlternative: this|this) {
		try {
			for (let condition of StructureAlternative._listeConditions
				.children) {
				if (
					condition
