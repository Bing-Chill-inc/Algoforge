 ...
 */
export class AvertissementInformationsInconsistantesSi extends AvertissementConceptuel {
	// ATTRIBUTS
	__nomsVariablesConcernees!: any[]; // array<String>
	 ...
	 */
	constructor(elementEmetteur: any, nomsVariablesConcernees = new Array()) {
	 ...
	 */
	set _nomsVariablesConcernees(value: any[]) {
		this.__nomsVariablesConcernees = value;
	}
	/**
	...
	get _nomsVariablesConcernees() {
		return this.__nomsVariablesConcernees;
	}
	// METHODES
	/**
	 ...
	 */
	static detecterAnomalie(StructureAlternative: this) {
		try {
			/*
            a = 3 | b = 5
            a = 4 | b= 4 && a = 3 | b=3 && a = 3
            */
			...
			for (let condition of conditions) {
				...
				for (let condition of conditions) {
					...
					let ontEnCommun = mesVariables.some((variable: any) =>
