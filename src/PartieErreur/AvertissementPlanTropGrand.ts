 ...
 */
export class AvertissementPlanTropGrand extends AvertissementConceptuel {
	// ATTRIBUTS -- Non --
	 ...
	 */
	static detecterAnomalie(unPlan: this) {
		try {
			let distanceMax = 10;
	 ...
	 */
	static calculerDistance(x1: number, y1: number, x2: number, y2: number) {
