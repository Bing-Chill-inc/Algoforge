 ...
 */
export class ErreurComparaisonSwitch extends ErreurConceptuelle {
	// ATTRIBUTS
	__nomDonnee!: String; // String
	 ...
	 */
	constructor(elementEmetteur: any, nomDonnee = new String()) {
	 ...
	 */
	set _nomDonnee(value: String) {
		this.__nomDonnee = value;
	}
	/**
	 ...
	 */
	static detecterAnomalie(StructureSwitch: this) {
		try {
