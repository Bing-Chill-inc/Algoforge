 ...
 */
export class AvertissementSProblemeJamaisExecute extends AvertissementConceptuel {
	// ATTRIBUTS
	...
	static detecterAnomalie(unArret: this) {
		try {
			const listeParent = unArret.getAntescedants(classes.StructureAlternative);
