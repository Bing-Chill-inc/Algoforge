 ...
 */
export class AvertissementTropDeSousElements extends AvertissementConceptuel {
	// ATTRIBUTS
	__listeElementsConcernes!: any[]; // array<ElementGraphique>
	 ...
	 */
	constructor(elementEmetteur: any, listeElementsConcernes = new Array()) {
	 ...
	 */
	set _listeElementsConcernes(value: any[]) {
		this.__listeElementsConcernes = value;
	}
	/**
	...
	get _listeElementsConcernes() {
		return this.__listeElementsConcernes;
	}
	// METHODES
	/**
	 ...
	 */
	static detecterAnomalie(unElementGraphique: this|this|this|this|this) {
		try {
