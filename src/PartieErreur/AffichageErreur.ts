import { isExam } from "../runtime/runtime";

export class AffichageErreur extends HTMLElement {
	_boutton: any;
	_listeErreur!: string|any[];
	_courant!: number;
	_divErreur!: HTMLDivElement|null;
	_imageTest!: HTMLDivElement;
	constructor() {
		super();
		if (isExam) return;
