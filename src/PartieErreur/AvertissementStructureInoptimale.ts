 ...
 */
export class AvertissementStructureInoptimale extends AvertissementConceptuel {
	// ATTRIBUTS
	__nomVariable!: String; // String
	__valeurs!: any[]; // array<String>
	 ...
	 */
	set _valeurs(value: any[]) {
		this.__valeurs = value;
	}
	/**
