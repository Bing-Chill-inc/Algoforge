import { PlanTravail } from "./PlanTravail";
 ...
 */
export class SousPlanTravail extends PlanTravail {
	// ATTRIBUTS
	 ...
	 */
	getRelativeChildrenToTop(abscisseRelatif: string|number, ordonneeRelatif: string|number) {
