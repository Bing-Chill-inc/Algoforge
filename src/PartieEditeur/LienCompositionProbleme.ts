 ...
 * @extends {Lien}
 */
export class LienCompositionProbleme extends Lien {
	// ATTRIBUTS
	...
	constructor(elemGraphiqueParent: any, elemGraphiqueEnfant: any, espaceTravail: any) {
		...
		this._symboleDecomposition = new classes.SymboleDecomposition();
		this._ligneH = new classes.Ligne();
		this._ligneV = new classes.Ligne();
		this.update();
