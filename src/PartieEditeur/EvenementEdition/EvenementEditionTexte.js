class EvenementEditionTexte extends EvenementEdition {
     ...
     */
    annuler() {
        if (verbose) console.log("Annulation de l'événement de modification de texte");
    }
     ...
     */
    retablir() {
        if (verbose) console.log("Rétablissement de l'événement de modification de texte");
    }
}