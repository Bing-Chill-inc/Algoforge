...
import type { EvenementDeplacementElement } from "./EvenementDeplacementElement";
 ...
 */
export class EvenementDeplacementElementMultiples extends EvenementEdition {
	// ATTRIBUTS
	 ...
	 */
	ajouterElementDeplace(elementDeplace: EvenementDeplacementElement) {
