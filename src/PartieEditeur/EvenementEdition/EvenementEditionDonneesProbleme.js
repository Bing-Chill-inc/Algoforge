class EvenementEditionDonneesProbleme extends EvenementEditionTexte {
     ...
     */
    annuler() {
        if (verbose) console.log("Annulation de l'événement de modification de listeDonnes de problème");
     ...
     */
    retablir() {
        if (verbose) console.log("Rétablissement de l'événement de modification de listeDonnes de problème");
