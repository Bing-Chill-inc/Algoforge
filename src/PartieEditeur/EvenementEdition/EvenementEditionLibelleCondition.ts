import { EvenementEditionTexte } from "./EvenementEditionTexte";
import { verbose } from "../../runtime/runtime";

/**
 * @class EvenementEditionLibelleCondition
 * @classdesc Classe représentant un événement de modification du libellé d'une condition.
 * @extends EvenementEditionTexte
 */
export class EvenementEditionLibelleCondition extends EvenementEditionTexte {
	// ATTRIBUTS
	...
	annuler() {
		if (verbose)
			console.log(
				"Annulation de l'événement de modification de libellé de condition",
			);
	...
	retablir() {
		if (verbose)
			console.log(
				"Rétablissement de l'événement de modification de libellé de condition",
			);
