class EvenementEditionLibelleProbleme extends EvenementEditionTexte {
     ...
     */
    annuler() {
        if (verbose) console.log("Annulation de l'événement de modification de libellé de problème");
     ...
     */
    retablir() {
        if (verbose) console.log("Rétablissement de l'événement de modification de libellé de problème");
