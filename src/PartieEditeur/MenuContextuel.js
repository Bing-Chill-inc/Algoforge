		...
		if (this._selection.nbElementsSelectionnes == 0) {
			...
			ajouterElem.ajouterElementMenu(
				new ElementMenu("Problème", () => {
					...
					this._editeur._planActif.ajouterElement(Probleme, this._x, this._y, true);
					this.remove();
				})
			);
			...
			ajouterElem.ajouterElementMenu(
				new ElementMenu("Procédure", () => {
					...
					this._editeur._planActif.ajouterElement(Procedure, this._x, this._y, true);
					this.remove();
				})
			);
			...
			ajouterElem.ajouterElementMenu(
				new ElementMenu("Structure 'SI'", () => {
					...
					this._editeur._planActif.ajouterElement(StructureSi, this._x, this._y, true);
					this.remove();
				})
			);
			...
			ajouterElem.ajouterElementMenu(
				new ElementMenu("Structure 'SWITCH'", () => {
					...
					this._editeur._planActif.ajouterElement(StructureSwitch, this._x, this._y, true);
					this.remove();
				})
			);
			...
			ajouterElem.ajouterElementMenu(
				new ElementMenu("Structure itérative non bornée", () => {
					...
					this._editeur._planActif.ajouterElement(StructureIterativeNonBornee, this._x, this._y, true);
					this.remove();
				})
			);
			...
			ajouterElem.ajouterElementMenu(
				new ElementMenu("Instruction d'arrêt", () => {
					...
					this._editeur._planActif.ajouterElement(ConditionSortie, this._x, this._y, true);
					this.remove();
				})
			);
		...
		if (this._selection.nbElementsSelectionnes >= 1) {
			...
			exporter.ajouterElementMenu(
				new ElementMenu(".csv", () => {
					...
					for (let elem of this._editeur._planActif.children) {
						if (!this._selection.estSelectionne(elem) && elem != this && elem instanceof ElementGraphique) {
					...
					this._editeur._planActif.leDictionnaireDesDonnees.exporter("csv");
			...
			exporter.ajouterElementMenu(
				new ElementMenu(".xls", () => {
					...
					// On exporte le dictionnaire
					this._editeur._planActif.leDictionnaireDesDonnees.exporter("xls");
			...
			exporter.ajouterElementMenu(
				new ElementMenu(".md", () => {
					...
					// On exporte le dictionnaire
					this._editeur._planActif.leDictionnaireDesDonnees.exporter("md");
