 ...
 * @extends {HTMLElement}
 */
export class MenuCompte extends HTMLElement {
	// ATTRIBUTS
	_menuDiv!: HTMLDivElement;
	_boutonDeconnexion!: { addEventListener: (arg0: string,arg1: () => void) => void; };
	_boutonTheme: any;
	_menuIcone: any;
	_selectionTheme!: Element|null;
	_estOuvert = false;
	_user!: { urlPfp: any; pseudo: any; adresseMail: any; }|null;
MenuIcone: HTMLDivElement;
