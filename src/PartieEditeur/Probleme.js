...
class Probleme extends ElementGraphique {
	...
	replaceTexte(chaineAChercher, chaineARemplacer) {
		this.querySelector(".nom").textContent = this.querySelector(".nom").textContent.replace(
	...
	replaceTexteDonnee(chaineAChercher, chaineARemplacer) {
		this.querySelector(".donneesEditable").textContent = this.querySelector(".donneesEditable").textContent.replace(
			new RegExp("\\b" + chaineAChercher + "\\b", "g"),
			chaineARemplacer
		);
	}
	...
	replaceTexteResultat(chaineAChercher, chaineARemplacer) {
		this.querySelector(".resultatEditable").textContent = this.querySelector(
			".resultatEditable"
		).textContent.replace(new RegExp("\\b" + chaineAChercher + "\\b", "g"), chaineARemplacer);
	}
	...
	afficher() {
		...
		this.divDonneesEditable.addEventListener("focusout", (e) => {
			...
			this._editeur.ajouterEvenement(
				new EvenementEditionDonneesProbleme(this, this._listeDonnes, this.listeDonnes)
			);
		...
		this.divResultatsEditable.addEventListener("focusout", (e) => {
			...
			this._editeur.ajouterEvenement(
				new EvenementEditionResultatsProbleme(this, this._listeResultats, this.listeResultats)
			);
