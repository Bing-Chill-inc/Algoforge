...
export class SelectionRectangle extends HTMLElement {
	_x1!: number; // Abscisse du point de départ de la sélection
	_y1!: number; // Ordonnée du point de départ de la sélection
	_x2!: number; // Abscisse du point d'arrivée de la sélection
	_y2!: number; // Ordonnée du point d'arrivée de la sélection
	 ...
	 */
	placer(x1: number, y1: number, x2: number, y2: number) {
