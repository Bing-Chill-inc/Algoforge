class EvenementSuppressionLiaison extends EvenementEdition {
     ...
     */
    annuler() {
        if (verbose) console.log("Annulation de l'événement de suppression de liaison");
     ...
     */
    retablir() {
        if (verbose) console.log("Rétablissement de l'événement de suppression de liaison");
