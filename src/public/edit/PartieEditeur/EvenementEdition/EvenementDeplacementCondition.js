class EvenementDeplacementCondition extends EvenementEdition {
    ...
    annuler() {
        ...
        this._elementConcerne._structure.decalerCondition(this._elementConcerne, -this._indiceDecalage, true);
    }
     ...
     */
    retablir() {
        console.log("Rétablissement de l'événement de déplacement de condition");
        this._elementConcerne._structure.decalerCondition(this._elementConcerne, this._indiceDecalage, true);
    }
}