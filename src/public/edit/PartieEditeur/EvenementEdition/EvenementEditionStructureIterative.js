class EvenementEditionStructureIterative extends EvenementEdition {
    ...
    annuler() {
        ...
        if (verbose) console.log("Ancienne structure : ", this._ancienneStructure);
        if (verbose) console.log("Nouvelle structure : ", this._nouvelleStructure);
        if (this._ancienneStructure.estBornee) {
            invite.valider(true);
            if (verbose) console.log("Ancienne structure bornée, on valide");
        } else {
            invite.nonBorne(true);
            if (verbose) console.log("Ancienne structure non bornée, on annule");
        }
        // OLD /
        // if (this._ancienneStructure.estBornee) {
