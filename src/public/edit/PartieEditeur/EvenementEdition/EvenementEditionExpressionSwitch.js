class EvenementEditionExpressionSwitch extends EvenementEditionTexte {
     ...
     */
    annuler() {
        if (verbose) console.log("Annulation de l'événement de modification de Expression Switch");
     ...
     */
    retablir() {
        if (verbose) console.log("Rétablissement de l'événement de modification de Expression Switch");
