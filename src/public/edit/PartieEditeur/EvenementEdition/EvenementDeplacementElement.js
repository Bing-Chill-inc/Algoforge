class EvenementDeplacementElement extends EvenementEdition {
    ...
    constructor(elementConcerne) {
        ...
        this._anciennePos = [elementConcerne._abscisse, elementConcerne._ordonnee];
    }
     ...
     */
    ajouterNouvellePos() {
        this._nouvellePos = [this._elementConcerne._abscisse, this._elementConcerne._ordonnee];
